...
# --- cfg ---
cfg = SimpleNamespace(**{})
cfg.exp_name = "0_920_best_full_tf_efficientnetv2_s_in21k_ft_in1k"
...
cfg.model = SimpleNamespace(
    ...
    backbone=SimpleNamespace(
        backbone_name="models/tf_efficientnetv2_s.in21k_ft_in1k",
        init_checkpoint="weights/bc_pretrain_perch_distill_5s_tf_efficientnetv2_s_in21k_ft_in1k/encoder_efficientnet_b0.pt",
        pretrained=False,
        drop_rate=0.3,
        drop_path_rate=0.15,
    ),
