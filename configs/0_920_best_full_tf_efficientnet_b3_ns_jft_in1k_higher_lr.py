...
# --- cfg ---
cfg = SimpleNamespace(**{})
cfg.exp_name = "0_920_best_full_tf_efficientnet_b3_ns_jft_in1k_higher_lr"
...
cfg.model = SimpleNamespace(
    ...
    backbone=SimpleNamespace(
        backbone_name="models/tf_efficientnet_b3.ns_jft_in1k",
        init_checkpoint="weights/bc_pretrain_perch_distill_5s_tf_efficientnet_b3_ns_jft_in1k/encoder_efficientnet_b0.pt",
        pretrained=False,
        drop_rate=0.3,
        drop_path_rate=0.15,
    ),
